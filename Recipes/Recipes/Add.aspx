<%@ Page Title="Add" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Recipes.Add" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <p class="lead">&nbsp;</p>
        <h4>Click rid to add ingredients to recipe</h4>
        <p>&nbsp;</p>
    </div>
     <div>
